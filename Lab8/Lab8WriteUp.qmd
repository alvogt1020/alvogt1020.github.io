...
df = tibble(
  theta = c(0.5, 1, 1.5),
  win_prob = 1 - sapply(c(0.5, 1, 1.5), function(t) paltbinom(3, 1, 0.7, t))
)
...
altBBinom1.05 = daltbbinom(x=0,n=3,a=a,b=b,theta=0.5) + (1/3)*daltbbinom(x=1,n=3,a=a,b=b,theta=0.5)
altBBinom2.05 = (2/3)*daltbbinom(x=1,n=3,a=a,b=b,theta=0.5)
altBBinom3.05 = daltbbinom(x=3,n=3,a=a,b=b,theta=0.5) + (1/3)*daltbbinom(x=2,n=3,a=a,b=b,theta=0.5)
altBBinom4.05 = (2/3)*daltbbinom(x=2,n=3,a=a,b=b,theta=0.5)

altBBinom1.15 = daltbbinom(x=0,n=3,a=a,b=b,theta=1.5) + (1/3)*daltbbinom(x=1,n=3,a=a,b=b,theta=1.5)
altBBinom2.15 = (2/3)*daltbbinom(x=1,n=3,a=a,b=b,theta=1.5)
altBBinom3.15 = daltbbinom(x=3,n=3,a=a,b=b,theta=1.5) + (1/3)*daltbbinom(x=2,n=3,a=a,b=b,theta=1.5)
altBBinom4.15 = (2/3)*daltbbinom(x=2,n=3,a=a,b=b,theta=1.5)

# Plots
# putting data tg
  df = tibble(
    outcome = c("0-2", "1-2", "2-0", "2-1"),

    binomial = c(binom1, binom2, binom3, binom4),
    negativeBinomial = c(negBinom1, negBinom2, negBinom3, negBinom4),
    betaBinomial = c(betaBinom1, betaBinom2, betaBinom3, betaBinom4),
    althamBinomial.05 = c(altBinom1.05, altBinom2.05, altBinom3.05, altBinom4.05),
    althamBinomial.15 = c(altBinom1.15, altBinom2.15, altBinom3.15, altBinom4.15),
    althamBBinom.05 = c(altBBinom1.05, altBBinom2.05, altBBinom3.05, altBBinom4.05),
    althamBBinom.15 = c(altBBinom1.15, altBBinom2.15, altBBinom3.15, altBBinom4.15)
)
...
# graphs
  ...
  df |> ggplot() +
        ...
        ylab("Probability") +
        xlab("Match Outcome") +
        ggtitle("Altham's Multiplicative Binomial (Theta = 0.5)") +
        theme_bw()
  ...
  df |> ggplot() +
        ...
        ylab("Probability") +
        xlab("Match Outcome") +
        ggtitle("Altham's Multiplicative Binomial (Theta = 1.5)") +
        theme_bw()
  ...
  df |> ggplot() +
        ...
        ylab("Probability") +
        xlab("Match Outcome") +
        ggtitle("Altham's Multiplicative Beta-Binomial (Theta = 0.5)") +
        theme_bw()
  ...
  df |> ggplot() +
        ...
        ylab("Probability") +
        xlab("Match Outcome") +
        ggtitle("Altham's Multiplicative Beta-Binomial (Theta = 1.5)") +
        theme_bw()
```
